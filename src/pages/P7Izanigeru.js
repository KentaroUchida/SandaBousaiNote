  ...
  return (
    <>
      <Grid>
        <Grid>
          <img
            src="/img/pages/P7Izanigeru/sitteta.png"
            alt=""
        ...
        <Grid>
          <Card>
            <CardMedia>
              <img
                src="/img/pages/P7Izanigeru/hinanbasyo.png"
                alt=""
...
const CheckPlace = () => {
  return (
    <>
      <img
        alt=""
        src="/img/pages/P7Izanigeru/pict.png"
        style={{ maxWidth: "100%", height: "auto" }}
      />
    </>
  );
        ...
        <Grid item xs={6} sx={styles.grid}>
          <Card>
            <CardMedia>
              <img
                alt="津波災害"
                src="/img/pages/P7Izanigeru/kouzui.png"
                style={{ maxWidth: "100%", height: "auto" }}
              />
            </CardMedia>
            <CardContent>
        ...
        <Grid item xs={6} sx={styles.grid}>
          <Card>
            <CardMedia>
              <img
                alt="土砂災害"
                src="/img/pages/P7Izanigeru/dosya.png"
                style={{ maxWidth: "100%", height: "auto" }}
              />
            </CardMedia>
            <CardContent>
  ...
  return (
    <>
      <Card>
        ...
        <p>
          水害、土砂、地震、火災など災害によって複数の逃げる場所を持つことが大切です。
        </p>
        <img
          alt="防災マップ"
          src="/img/pages/P7Izanigeru/bousaiMap.png"
...
const ShelterInformation = () => {
  const [shelters, setShelters] = useState(
    JSON.parse(localStorage.getItem("P17Izanigeru")) || {}
  );
